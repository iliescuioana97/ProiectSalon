...
class MP_Entrepreneur_Admin_Setup_Wizard {
	...
	public function admin_menus() {
		add_theme_page( __( 'Theme Wizard', 
			'entrepreneur'  ), __( 'Theme Wizard', 
			'entrepreneur'  ), 'edit_theme_options', 'theme-setup', array( $this, 'setup_wizard' ) );
	}
...
public function setup_wizard_header() {
	...
	<div class="wrap">
		<h2 class="text-center"
		    style="margin-top: 0px;"><?php _e( 'Theme Quick Guided Tour', 
				'entrepreneur'  ); ?></h2>
		<?php
		}
	...
	public function setup_introduction() {
		?>
		<h2><?php _e( 'Welcome to the Entrepreneur Theme!', 
				'entrepreneur'  ); ?></h2>
		<table class="form-table">
			<tbody>
			<tr>
				<td>
					<p><?php _e( 'Thank you for choosing Entrepreneur theme. This quick guided tour will show you how to:', 
							'entrepreneur'  ); ?></p>
					<ul>
						<li>
							- <?php _e( 'easily customize the theme in a few steps;', 
								'entrepreneur'  ); ?></li>
						<li>- <?php _e( 'change colors, texts and images;', 
								'entrepreneur'  ); ?></li>
						<li>
							- <?php _e( 'start a business website and build pages visually.', 
								'entrepreneur'  ); ?></li>
					</ul>
					<p>
						<i><?php _e( 'If you don&rsquo;t want to go through the wizard, you can', 
								'entrepreneur'  ); ?>
							<a href="<?php echo esc_url( admin_url( 'themes.php' ) ); ?>"
							   class=""><?php _e( 'skip and return to the WordPress dashboard.', 
									'entrepreneur'  ); ?></a>
							<?php _e( 'This Wizard is always available under Appearance > Theme Wizard menu.', 
								'entrepreneur'  ); ?></i></p>
				</td>
			</tr>
			</tbody>
		...
		<p class="theme_setup-actions step text-center">
			<a href="<?php echo esc_url( $this->get_next_step_link() ); ?>"
			   class="button button-primary button-large"><?php _e( 'Let\'s Go!', 
					'entrepreneur'  ); ?></a>
		</p>
	...
	public function setup_customizer() {
		...
		<p class="theme_setup-actions step " style="float:right; margin: -0.3em 0 0;">
			...
			if ( $this->checkPlugins() ) :
				...
				<a href="<?php echo esc_url( $url ); ?>"
				   class="button button-primary button-large"><?php _e( 'Continue', 
						'entrepreneur'  ); ?></a>
			<?php else: ?>
				<a href="<?php echo esc_url( $this->get_next_step_link() ); ?>"
				   class="button button-primary button-large"><?php _e( 'Continue', 
		...
		<h2><?php _e( 'Customizer', 
				'entrepreneur'  ); ?></h2>
		<table class="form-table">
			<tbody>
			<tr>
				<td colspan="2">
					<p><?php _e( 'One of the main tools of this theme is WordPress Customizer. Navigate to <strong>Appearance > Customize</strong> to change logo, website title, contact information, colors, background image, menus and so on. Once you are done with the changes click &rdquo;Save&rdquo; button  to display  updates on the live site.', 
							'entrepreneur'  ); ?></p>
				</td>
			</tr>
			<tr colspan="2">
				<td>
					<h3><?php _e( '1. Site Identity', 
							'entrepreneur'  ); ?></h3>
				</td>
			</tr>
			<tr>
				...
				<td>
					<p><?php _e( 'The Site Identity section in customizer allows you to change the site title, description, and control whether or not you want to display them in the header.', 
							'entrepreneur'  ); ?></p>
				</td>
			</tr>
			<tr colspan="2">
				<td>
					<h3><?php _e( '2. Theme Colors', 
							'entrepreneur'  ); ?></h3>
				</td>
			</tr>
			<tr>
				...
				<td>
					<p><?php _e( 'In this section you can choose between 4 predefined color schemes, modify header text color, color of the text content and change accent color for buttons.', 
							'entrepreneur'  ); ?></p>
				</td>
			</tr>
			</tbody>
		...
		<p class="theme_setup-actions step text-right">
			<a href="<?php echo esc_url( admin_url( 'themes.php' ) ); ?>"
			   class="button button-large"><?php _e( 'Exit', 
					'entrepreneur'  ); ?></a>
		</p>
		<?php
	}
	...
	public function setup_section() {
		...
		<table class="form-table">
			...
			<tr>
				<td colspan="2">
					<p><?php _e( 'A huge feature of this theme is completely customizable Front Page. Front Page is the main page of your website that includes all content blocks you may need to build website. Features, Call to action, Portfolio, Contact form, Google Maps and many other blocks are available for you from the box. How to setup your Front Page:', 
							'entrepreneur'  ); ?></p>
				</td>
			</tr>
			<tr colspan="2">
				<td>
					<h3><?php _e( '1. Create Front Page', 
							'entrepreneur'  ); ?></h3>
				</td>
			</tr>
			<tr>
				...
				<td>
					<ul>
						<li><?php _e( '1. Follow this link to ', 
								'entrepreneur'  ); ?> <a
								href="<?php echo esc_url( admin_url( 'post-new.php?post_type=page' ) ); ?>"
								target="_blank"><?php _e( 'Create New Page', 
									'entrepreneur'  ); ?></a></li>
						<li><?php _e( '2. Name it "Home" or "Front Page"', 
								'entrepreneur'  ); ?></li>
						<li>
							<strong><?php _e( '3. Choose "Customizable Front Page" template', 
									'entrepreneur'  ); ?></strong></li>
						<li><?php _e( '4. Press Publish button', 
								'entrepreneur'  ); ?></li>
					</ul>
					<p class="description"><?php _e( 'For more information, please view', 
							'entrepreneur'  ); ?> <a
			...
			<tr>
				...
				<td>
					<ul>
						<li><?php _e( '1. Navigate to ', 
								'entrepreneur'  ); ?> <a
								href="<?php echo esc_url( admin_url( 'options-reading.php' ) ); ?>"
								target="_blank"><?php _e( 'Settings -> Reading', 
									'entrepreneur'  ); ?></a></li>
						<li><?php _e( '2. In Settings -> Reading, set "Front page displays" to "A static page"', 
								'entrepreneur'  ); ?></li>
						<li><?php _e( '2. In Settings -> Reading, set "Front page" to "Home" or "Front Page" you\'ve created in first step', 
								'entrepreneur'  ); ?></li>
						<li><?php _e( '3. Scroll down and Save changes', 
								'entrepreneur'  ); ?></li>
					</ul>
					<p class="description"><?php _e( 'For more information, please view', 
							'entrepreneur'  ); ?> <a
			...
			<tr>
				<td colspan="2">
					<h3><?php _e( '3. Setup Posts Page (Blog)', 
							'entrepreneur'  ); ?></h3>
				</td>
			</tr>
			<tr>
				...
				<td>
					<ul>
						<li><?php _e( '1. Create new page and name it "Blog"', 
								'entrepreneur'  ); ?></li>
						<li><?php _e( '2. In Settings -> Reading, set "Posts page" to "Blog"', 
								'entrepreneur'  ); ?></li>
						<li><?php _e( '3. Scroll down and Save changes', 
								'entrepreneur'  ); ?></li>
					</ul>
	...
	public function setup_ready() {
		?>
		<h2 class="text-center"><?php _e( 'You are Ready!', 
				'entrepreneur'  ); ?></h2>
		<p><?php _e( 'Thank you for choosing Proift theme.', 
				'entrepreneur'  ); ?></p>
		<hr/>
		<p class="theme_setup-actions step">
			<a href="<?php echo esc_url( admin_url( 'customize.php' ) ); ?>"
			   class="button button-primary button-large"><?php _e( 'Customize this theme', 
					'entrepreneur'  ); ?></a>
			<a href="<?php echo esc_url( admin_url( 'themes.php' ) ); ?>"
			   class="button button-large"><?php _e( 'Return to the WordPress Dashboard', 
					'entrepreneur'  ); ?></a>
		</p>
		<?php
	}
	...
	public function checkPlugins() {
		...
		if ( ( is_plugin_active( 'mp-entrepreneur/mp-entrepreneur.php' ) && is_plugin_active( 'booked/booked.php' ) && is_plugin_active( 'motopress-content-editor/motopress-content-editor.php' ) ) ) {
	...
	public function setup_plugins() {
		...
		<form method="post" action="<?php echo esc_url( $this->get_next_step_link() ); ?>">
			<p class="theme_setup-actions step" style="float:right; margin: -0.3em 0 0;">
				...
				?>
				<a href="<?php echo esc_url( $url ); ?>"
				   class="button"><?php _e( 'Skip', 
						'entrepreneur'  ); ?></a>
				<input class="button button-primary" type="submit" value="Install Plugins">
			</p>
			<h2><?php _e( 'This theme recommends the following free plugins:', 
					'entrepreneur'  ); ?></h2>
			<br>
			...
			if ( ! isset( $installed_plugins['mp-entrepreneur/mp-entrepreneur.php'] ) ) :
				...
				<div class="checkbox" style="margin-bottom: 15px;">
					<label>
						...
						<?php _e( 'Entrepreneur Theme Engine', 
							'entrepreneur'  ) ?>
						<p class="description"><?php _e( 'Adds Front Page Sections to this theme.', 
								'entrepreneur'  ) ?></p>
			...
			<?php elseif ( is_plugin_inactive( 'mp-entrepreneur/mp-entrepreneur.php' ) ) : ?>
				<div class="checkbox" style="margin-bottom: 15px;">
					<label>
						...
						<?php _e( 'Entrepreneur Theme Engine', 
							'entrepreneur'  ) ?>
						<p class="description"><?php _e( 'Activate this plugin.', 
								'entrepreneur'  ); ?></p>
					</label>
				</div>
			<?php endif; ?>
			...
			if ( ! isset( $installed_plugins['motopress-content-editor/motopress-content-editor.php'] ) ) :
				...
				<div class="checkbox" style="margin-bottom: 15px;">
					<label>
						...
						<?php _e( 'MotoPress Content Editor', 'entrepreneur' ) ?>
						<p class="description"><?php _e( 'Enhances the standard WordPress editor and enables to build websites visually. It\'s complete solution for building responsive pages without coding and simply by dragging and dropping content elements.', 'entrepreneur' ) ?></p>
					</label>
				</div>
			<?php elseif ( is_plugin_inactive( 'motopress-content-editor/motopress-content-editor.php' ) ) : ?>
				<div class="checkbox" style="margin-bottom: 15px;">
					<label>
						...
						<?php _e( 'MotoPress Content Editor', 'entrepreneur' ) ?>
						<p class="description"><?php _e( 'Activate this plugin.', 'entrepreneur' ); ?></p>
					</label>
				</div>
				<?php
			endif;
			...
			if ( ! isset( $installed_plugins['booked/booked.php'] ) ) :
				?>
				<div class="checkbox" style="margin-bottom: 15px;">
					<label>
						<input type="checkbox" value="1" checked="checked" name="plugins[booked_install]">
						<?php _e( 'Booked', 'entrepreneur' ) ?>
						<p class="description"><?php _e( 'Appointment Booking.', 'entrepreneur' ) ?></p>

					</label>
				</div>
			<?php elseif ( is_plugin_inactive( 'booked/booked.php' ) ) : ?>
				<div class="checkbox" style="margin-bottom: 15px;">
					<label>
						<input type="checkbox" value="1" checked="checked" name="plugins[booked_activate]">
						<?php _e( 'Booked', 'entrepreneur' ) ?>
						<p class="description"><?php _e( 'Activate this plugin.', 'entrepreneur' ); ?></p>
					</label>
				</div>
			...
			<p class="theme_setup-actions step text-right" style="float:right; margin-top: 0.5em;">
				...
				?>
				<a href="<?php echo esc_url( $url ); ?>"
				   class="button button-large"><?php _e( 'Skip', 
						'entrepreneur'  ); ?></a>
	...
	public function setup_install_plugins() {
		...
		<h2><?php _e( 'Installing the plugins (this may take awhile)', 
				'entrepreneur'  ); ?></h2>
		<?php
		if ( isset( $_POST["plugins"] ) ) :
			...
			if ( sizeof( $array ) > 0 ) {
				...
				if ( array_key_exists( "mp_entrepreneur_install", $array ) || array_key_exists( "mp_entrepreneur_activate", $array ) ) {
					_e( '<h4>Entrepreneur Theme Engine</h4>', 
						'entrepreneur'  );
				}
				if ( array_key_exists( "mp_entrepreneur_install", $array ) ) {
					...
					$plugin_name = __( 'Entrepreneur Theme Engine', 
						'entrepreneur'  );
					echo '<p>' . sprintf( __( 'Activating %s plugin...', 
							'entrepreneur'  ), $plugin_name ) . '</p>';
				...
				if ( array_key_exists( "motopress_install", $array ) || array_key_exists( "motopress_activate", $array ) ) {
					_e( '<h4>MotoPress Content Editor</h4>', 'entrepreneur' );
				}
				if ( array_key_exists( "motopress_install", $array ) ) {
					...
					$plugin_name = __( 'MotoPress Content Editor', 'entrepreneur' );
					echo '<p>' . sprintf( __( 'Activating %s plugin...', 'entrepreneur' ), $plugin_name ) . '</p>';
					$this->activate_plugin( $plugin_name, $plugin_path );
				}
				...
				if ( array_key_exists( "booked_install", $array ) || array_key_exists( "booked_activate", $array ) ) {
					_e( '<h4>Booked</h4>', 'entrepreneur' );
				}
				if ( array_key_exists( "booked_install", $array ) ) {
					$plugin = 'booked';
					$url    = get_template_directory_uri() . '/assets/booked.zip';
					$this->install_plugin( $plugin, $url );
					$plugin_path = 'booked/booked.php';
					$plugin_name = __( 'Booked', 'entrepreneur' );
					echo '<p>' . sprintf( __( 'Activating %s plugin...', 'entrepreneur' ), $plugin_name ) . '</p>';
					$this->activate_plugin( $plugin_name, $plugin_path );
				}
				if ( array_key_exists( "booked_activate", $array ) ) {
					$plugin_path = 'booked/booked.php';
					$plugin_name = __( 'Booked', 'entrepreneur' );
					echo '<p>' . sprintf( __( 'Activating %s plugin...', 'entrepreneur' ), $plugin_name ) . '</p>';
					$this->activate_plugin( $plugin_name, $plugin_path );
	...
	public function activate_plugin( $plugin_name, $plugin_path ) {
		...
		if ( is_wp_error( $result ) ) {
			echo '<p>' . $plugin_name . ' ' . __( 'plugin is not activated', 
					'entrepreneur'  ) . '</p>';
		} else {
			echo '<p>' . $plugin_name . ' ' . __( 'plugin is activated', 
					'entrepreneur'  ) . '</p>';
		}
	}
