...
class MP_Entrepreneur_Custom_Header {
	...
	function header_style() {
		...
		<style type="text/css" id="theme-header-css">
			...
			body .first-section .widget_booked_calendar .widgettitle, body .first-section .widget_booked_calendar .widget-title {
				background: <?php echo $brand_color;?>;
			}
			body .first-section .widget_booked_calendar .widgettitle:after, body .first-section .widget_booked_calendar .widget-title:after {
