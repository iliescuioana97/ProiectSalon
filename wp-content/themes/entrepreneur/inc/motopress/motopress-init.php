...
// button inner
            ...
            if ($buttonGroupInnerObj) {
                ...
                $buttonGroupInnerObj->parameters['color']['list']['mp-theme-button-brand'] = __('Theme Brand',  'entrepreneur' );
                $buttonGroupInnerObj->parameters['color']['list']['mp-theme-button-white'] = __('Theme White',  'entrepreneur' );
...
// service box
            ...
            if ($serviceBoxObj) {
                ...
                $serviceBoxObj->parameters['icon_color']['list']['mp-theme-icon-brand'] = __('Theme Brand',  'entrepreneur' );
                $serviceBoxObj->parameters['icon_color']['default'] = 'mp-theme-icon-brand';
                $serviceBoxObj->parameters['button_color']['list']['mp-theme-button-brand'] = __('Theme Brand',  'entrepreneur' );
...
// call 
            ...
            if ($ctaObj) {
                ...
                $ctaObj->parameters['icon_color']['list']['mp-theme-icon-white'] = __('Theme Brand',  'entrepreneur' );
                $ctaObj->parameters['icon_color']['default'] = 'mp-theme-icon-white';
                $ctaObj->parameters['style']['list']['brand'] = __('Theme Brand',  'entrepreneur' );
                ...
                $ctaObj->parameters['button_color']['list']['mp-theme-button-white'] = __('Theme White',  'entrepreneur' );
...
// tab
        ...
        if ($tabObj) {
            $tabObj->parameters['icon_color']['list']['mp-theme-icon-brand'] = __('Theme Brand',  'entrepreneur' );
