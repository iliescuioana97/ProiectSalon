	...
	<section id="news" class="news-section default-section">
		<div class="container">
			<div class="section-content">
				...
				$mp_entrepreneur_news_button_label = esc_html( get_theme_mod( mp_entrepreneur_get_prefix() . 'news_button_label',__( 'all news', 
					'entrepreneur'  ) ) );
				?>
				<div class="section-table-wrapper">
					<div class="section-header">
						...
						if ( get_theme_mod( mp_entrepreneur_get_prefix() . 'news_title', false ) === false ) :
							?>
							<h2 class="section-title"><?php _e( 'Tips & News', 
									'entrepreneur'  ); ?></h2>
							<?php
						else:
						...
						if ( get_theme_mod( mp_entrepreneur_get_prefix() . 'news_subtitle', false ) === false ) :
							?>
							<div
								class="section-subtitle"><?php _e( 'Updates from the blog', 
									'entrepreneur'  ); ?></div>
							<?php
						else:
					...
					<div class="section-buttons">
						...
						if ( get_theme_mod( mp_entrepreneur_get_prefix() . 'news_button_url', false ) === false ) :
							?>
							<a href="#news" title="<?php _e( 'all news', 
								'entrepreneur'  ) ?>"
							   class="button button-white "><?php _e( 'all news', 
									'entrepreneur'  ) ?></a>
							<?php
						else:
									...
									<div class="post-wrapper">
										<div class="wpapper-content">
											...
											<div class="entry entry-content">
												<p>
													<?php mp_entrepreneur_get_content_theme( 177 ); ?>
												</p>
											</div>
										</div>
									</div>
