 ...
 * @abstract 
 */
abstract class MP_Entrepreneur_Plugin_Widget_Default extends WP_Widget {
    ...
    function __construct() {
        if (!defined('THEMENAMEENTREPRENEUR')) {
            define('THEMENAMEENTREPRENEUR', 'Entrepreneur');
        }
        $this->setPrefix('mp-entrepreneur');
        $this->setTextdomain('mp-entrepreneur');
    ...
    protected function getTranslatedName() {
        return THEMENAMEENTREPRENEUR . $this->getNameDelimiter() . $this->getName();
    }
