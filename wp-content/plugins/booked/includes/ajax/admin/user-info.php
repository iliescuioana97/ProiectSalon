...
if (!$_POST['user_id'] && isset($_POST['appt_id'])):
    ...
    if ($guest_email) : echo '<p class="booked-modal-list-item"><strong class="booked-left-title">' . esc_html__('Email', 'booked') . ':</strong> <a href="mailto:' . $guest_email . '">' . $guest_email . '</a></p>';
    endif;
    ...
    if ($email) : echo '<p class="booked-modal-list-item"><strong class="booked-left-title">' . esc_html__('Email', 'booked') . ':</strong> <a href="mailto:' . $email . '">' . $email . '</a></p>';
    endif;
    if ($phone) : echo '<p class="booked-modal-list-item"><strong class="booked-left-title">' . esc_html__('Phone', 'booked') . ':</strong> <a href="tel:' . preg_replace('/[^0-9+]/', '', $phone) . '">' . $phone . '</a></p>';
    endif;
