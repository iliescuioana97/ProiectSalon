    ...
    class Booked_Admin_AJAX {
        ...
        public function booked_admin_add_timeslots() {
            ...
            if (isset($_POST['day']) && isset($_POST['startTime']) && isset($_POST['endTime'])):
                ...
                if (empty($booked_defaults)): $booked_defaults = array();
                endif;

                do {

                    $newStartTime = date_i18n("Hi", strtotime('+' . $interval . ' minutes', strtotime($startTime)));
                    if (!empty($booked_defaults[$day][$startTime . '-' . $newStartTime])): $currentCount = $booked_defaults[$day][$startTime . '-' . $newStartTime];
                    else : $currentCount = 0;
                    endif;
        ...
        public function booked_admin_add_timeslot() {
            ...
            if (isset($_POST['day']) && isset($_POST['startTime']) && isset($_POST['count'])):
                ...
                if (!empty($booked_defaults[$day][$startTime . '-' . $endTime])): $currentCount = $booked_defaults[$day][$startTime . '-' . $endTime];
                else : $currentCount = 0;
                endif;
        ...
        public function booked_admin_custom_timeslots_list() {
            ...
            if (isset($_POST['json_array'])):
                ...
                if ($_POST['end_date']): $this_timeslot['booked_custom_end_date'] = $_POST['end_date'];
                else: $this_timeslot['booked_custom_end_date'] = $_POST['start_date'];
                endif;
